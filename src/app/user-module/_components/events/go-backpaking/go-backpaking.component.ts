...
@Component({
  selector: 'ga-go-backpaking',
  templateUrl: './go-backpaking.component.html',
  styleUrls: ['./go-backpaking.component.css'],
  animations: [slider],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class GoBackpakingComponent implements OnInit {
  ...
  ngOnInit() {
    this._userService.get('User/GetAllEvents').subscribe((response) => {
      ...
      this.upComingEventsAll = this.upComingEventsAll.filter(x => x.EventType === 'Go Backpacking');
    })
